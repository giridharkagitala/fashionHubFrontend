...
const OrdersTable = () => {
  ...
  const [showCanceled, setShowCanceled] = useState(false); // State for the checkbox
  ...
  // },[])
   ...
   // Filter orders dynamically based on showCanceled state
  const filteredOrders = showCanceled
    ? orders.filter((order) => order.orderStatus === "CANCELLED") // Only show canceled orders
    : orders;
