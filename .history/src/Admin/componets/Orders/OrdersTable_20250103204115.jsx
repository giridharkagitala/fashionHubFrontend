...
const OrdersTable = () => {
  ...
  const filteredOrders = selectedStatus
    ? adminsOrder.orders.filter((order) =>
  ...
  const handleProcessReturnOrder = (orderId, status) => {
    dispatch(processReturnOrder(orderId, status, jwt));
  };
        ...
        <CardHeader
          ...
          action={
            <div className="flex space-x-4">
              {["On The Way", "Delivered", "Cancelled", "Returned", "Return Pending"].map(
                (status) => (
                  <FormControlLabel
                    key={status}
                    control={
          ...
          <Table sx={{ minWidth: 800 }} aria-label="table in dashboard">
            <TableHead>
              <TableRow>
                ...
                <TableCell sx={{ textAlign: "center" }}>Return Status</TableCell>
                  ...
                  <TableCell sx={{ textAlign: "center" }}>
                    {item.returnStatus === "PENDING" && (
                      <div>
                        <Button
                          onClick={() =>
                            handleProcessReturnOrder(item.id, "APPROVED")
                          }
                          variant="contained"
                          color="primary"
                        >
                        ...
                        <Button
                          onClick={() =>
                            handleProcessReturnOrder(item.id, "REJECTED")
                          }
                          variant="contained"
                          color="error"
                        >
