...
import { Box, Button, Grid, LinearProgress, Modal, Rating, TextField, Typography } from "@mui/material";
...
import { createBackorder } from "../../../../Redux/Backorders/Action";
...
export default function ProductDetails() {
  ...
  const [backorderQuantity, setBackorderQuantity] = useState(1);
  ...
  const handleBackorderSubmit = () => {
    const backorderData = {
      productId: Number(productId),
      quantity: backorderQuantity,
      jwt,
    };
    dispatch(createBackorder(backorderData)); // Dispatch the Redux action
    setBackorderModalOpen(false); // Close the modal
    alert("Backorder created successfully!"); // Show confirmation
  };
          ...
          <div className="lg:col-span-1 mx-auto max-w-2xl px-4 pb-16 sm:px-6  lg:max-w-7xl  lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <form className="mt-10" onSubmit={handleSubmit}>
                ...
                {customersProduct.product?.stock <= 0 && (
                  <Button
                    variant="outlined"
                    color="error"
                    onClick={() => setBackorderModalOpen(true)}
                    sx={{ marginTop: "1rem" }}
                  >
                    Backorder Now
                  </Button>
              ...
              {/* Backorder Modal */}
              <Modal open={backorderModalOpen} onClose={() => setBackorderModalOpen(false)}>
                <Box className="p-5 bg-white shadow-lg rounded-md max-w-md mx-auto mt-20">
                  <Typography variant="h6" className="text-center">
                    Backorder Product
                  </Typography>
                  <Typography variant="body1" className="mt-3">
                    Enter the quantity for backorder:
                  </Typography>
                  <TextField
                    type="number"
                    value={backorderQuantity}
                    onChange={(e) => setBackorderQuantity(e.target.value)}
                    fullWidth
                    sx={{ marginTop: "1rem" }}
                  />
                  <div className="flex justify-between mt-5">
                    <Button variant="outlined" onClick={() => setBackorderModalOpen(false)}>
                      Cancel
                    </Button>
                    <Button
                      variant="contained"
